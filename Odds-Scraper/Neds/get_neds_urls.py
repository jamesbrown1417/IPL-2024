...
url_pattern = "https://api.neds.com.au/v2/sport/event-request?category_ids=%5B%2294984918-dbac-432b-b420-c219ec9203f4%22%5D&include_any_team_vs_any_team_events=true"
...
async def main():
    async with async_playwright() as p:
        ...
        await page.goto("https://www.neds.com.au/sports/cricket/ipl", wait_until="networkidle")
